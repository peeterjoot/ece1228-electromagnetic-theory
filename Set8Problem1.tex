...
\begin{equation}\label{eqn:emtproblemSet8Problem1:40}
\begin{aligned}
\kcap_1
&= \Be_3 e^{i \theta_1}
...
\end{aligned}
\end{equation}
\begin{equation}\label{eqn:emtproblemSet8Problem1:60}
\begin{aligned}
\kcap_1'
&= -\Be_3 e^{-i \theta_1'}
\\ &= -\Be_3 \cos\theta_1' + \Be_1 \sin\theta_1'
\end{aligned}
\end{equation}
\begin{equation}\label{eqn:emtproblemSet8Problem1:80}
\begin{aligned}
\kcap_2
&= \Be_3 e^{i \theta_2}
...
\begin{equation}\label{eqn:emtproblemSet8Problem1:100}
\begin{aligned}
-j \omega \mu \BH
&=
\spacegrad \cross \BE
...
\end{equation}
or
\begin{equation}\label{eqn:emtproblemSet8Problem1:120}
\begin{aligned}
\BH
&=
...
\begin{equation}\label{eqn:emtproblemSet8Problem1:160}
\begin{aligned}
\Ecap_i
&=
\kcap_1 i
...
\end{aligned}
\end{equation}
\begin{equation}\label{eqn:emtproblemSet8Problem1:180}
\begin{aligned}
\Ecap_r
&=
\kcap_1' (-i)
...
\end{aligned}
\end{equation}
\begin{equation}\label{eqn:emtproblemSet8Problem1:200}
\begin{aligned}
\Ecap_t
&=
\kcap_2 i
...
\begin{equation}\label{eqn:emtproblemSet8Problem1:360}
\frac{E_0}{\eta_1} e^{-j \Bk_1 \cdot \Bx}
-\frac{E_0 r}{\eta_1} e^{-j \Bk_1' \cdot \Bx}
=
\frac{t E_0}{\eta_2} e^{-j \Bk_2 \cdot \Bx}
\end{equation}
\begin{equation}\label{eqn:emtproblemSet8Problem1:380}
...
\begin{equation}\label{eqn:emtproblemSet8Problem1:440}
k_1 \sin\theta_1 = k_1 \sin\theta_1'.
\end{equation}
%
The remaining phase equality is Snell's second law in disguise
\begin{equation}\label{eqn:emtproblemSet8Problem1:460}
\begin{aligned}
0
...
\end{equation}
or
\begin{equation}\label{eqn:emtproblemSet8Problem1:480}
...
\begin{equation}\label{eqn:emtproblemSet8Problem1:520}
\frac{1}{\eta_1}
-\frac{r}{\eta_1}
=
\frac{t}{\eta_2}
\end{equation}
\begin{equation}\label{eqn:emtproblemSet8Problem1:540}
\cos\theta_1(1 + r)
=
t \cos\theta_2
\end{equation}
\begin{equation}\label{eqn:emtproblemSet8Problem1:560}
...
\begin{equation}\label{eqn:emtproblemSet8Problem1:580}
\begin{aligned}
\begin{bmatrix}
r \\
t
...
\begin{equation}\label{eqn:emtproblemSet8Problem1:620}
\begin{aligned}
\eta_1 \cos\theta_1
&=
