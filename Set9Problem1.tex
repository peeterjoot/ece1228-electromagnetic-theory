...
%
\begin{equation}\label{eqn:emtproblemSet9Problem1:20}
\begin{bmatrix}
E_{l,i}' \\
E_{r,i}'
\end{bmatrix}
...
%
\begin{equation}\label{eqn:emtproblemSet9Problem1:40}
\BM
=
\inv{1 - \rho_{i,j}^2}
\begin{bmatrix}
...
%
\begin{equation}\label{eqn:emtproblemSet9Problem1:60}
\begin{aligned}
\begin{bmatrix}
E_{l,i}' \\
E_{r,i}'
...
%
\begin{equation}\label{eqn:emtproblemSet9Problem1:80}
\begin{aligned}
t
&= \frac{E}{E_{r,i}'}
...
%
\begin{equation}\label{eqn:emtproblemSet9Problem1:100}
\begin{aligned}
r
&= \frac{E_{l,i}'}{E_{r,i}'}
\\ &=
...
\begin{equation}\label{eqn:emtproblemSet9Problem1:120}
\begin{aligned}
r
&=
...
%
\begin{equation}\label{eqn:emtproblemSet9Problem1:140}
\begin{bmatrix}
E_{l,i}' \\
E_{r,i}'
\end{bmatrix}
...
%
then we can form
\begin{equation}\label{eqn:emtproblemSet9Problem1:180}
\begin{aligned}
\BM
\begin{bmatrix}
\Be_1 & \Be_2
...
so that
%
\begin{equation}\label{eqn:emtproblemSet9Problem1:220}
\BM = \BE \BD \BE^{-1}.
\end{equation}
%
Integer powers of \( \BM \) can now be computed easily
%
\begin{equation}\label{eqn:emtproblemSet9Problem1:240}
\begin{aligned}
\BM^N
&=
...
This gives
%
\begin{equation}\label{eqn:emtproblemSet9Problem1:260}
\begin{bmatrix}
E_{l,i}' \\
E_{r,i}'
\end{bmatrix}
