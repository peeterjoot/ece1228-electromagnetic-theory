...
%
\begin{equation}\label{eqn:emtProblemSet2Problem4:20}
...
%
\begin{equation}\label{eqn:emtProblemSet2Problem4:40}
V(\Br)
...
\\ &=
\frac{\Abs{\BP} }{2 \epsilon_0}
\int_{-d-z}^{-z} du \lr{ \frac{ u }{\sqrt{u^2 + a^2}} - \sgn\lr{u}}.
\end{aligned}
\end{equation}
%
...
%
\begin{equation}\label{eqn:emtProblemSet2Problem4:140}
\begin{aligned}
V(z)
&=
...
or
%
%\begin{equation}\label{eqn:emtProblemSet2Problem4:160}
...
Let
%
\begin{equation}\label{eqn:emtProblemSet2Problem4:200}
f(z) = \sqrt{ z^2 + a^2 },
\end{equation}
%
...
%
\begin{equation}\label{eqn:emtProblemSet2Problem4:220}
f'(z) = \frac{z}{\sqrt{z^2 + a^2}}.
\end{equation}
%
%The second derivative is
%\begin{equation}\label{eqn:emtProblemSet2Problem4:240}
%\begin{aligned}
%f''(z)
...
%
\begin{equation}\label{eqn:emtProblemSet2Problem4:260}
f(z + d) - f(z)
\approx f'(z) d
=
...
\begin{equation}\label{eqn:emtProblemSet2Problem4:280}
V(z)
\approx
...
%
or
%\begin{equation}\label{eqn:emtProblemSet2Problem4:360}
...
\begin{equation}\label{eqn:emtProblemSet2Problem4:320}
V(z)
\approx
