...
%
We will explore the important topic of magnetization here
%
...
\index{point charge}
%
\begin{equation}\label{eqn:emtLecture3:60}
\begin{aligned}
\BE
...
%
\begin{equation}\label{eqn:emtLecture3:80}
\begin{aligned}
\BE
&= \frac{q}{4 \pi \epsilon_0} \frac{\BR}{\Abs{\BR}^3}
\\ &= \frac{q}{4 \pi \epsilon_0} \frac{\BR}{R^3},
...
%
\begin{equation}\label{eqn:emtLecture3:100}
\BE
...
%
\begin{equation}\label{eqn:emtLecture3:120}
V
...
%
\begin{equation}\label{eqn:emtLecture3:140}
\BE
...
with potential
%
\begin{equation}\label{eqn:emtLecture3:160}
V
= \frac{1}{4 \pi \epsilon_0} \iiint dV' \frac{\rho_\txtv(\Br')}{\Abs{\Br - \Br'}}.
\end{equation}
%
\index{surface charge density}
The surface charge density analogue is
%
\begin{equation}\label{eqn:emtLecture3:180}
\BE
...
\begin{equation}\label{eqn:emtLecture3:200}
V
= \frac{1}{4 \pi \epsilon_0} \iint dA' \frac{\rho_\txts(\Br')}{\Abs{\Br - \Br'}}.
\end{equation}
%
The line charge density analogue is
%
\begin{equation}\label{eqn:emtLecture3:220}
\BE
...
with potential
%
\begin{equation}\label{eqn:emtLecture3:240}
V
...
\begin{equation}\label{eqn:emtLecture3:300}
\begin{aligned}
\BE
...
%
\begin{equation}\label{eqn:emtLecture3:320}
...
%
\begin{equation}\label{eqn:emtLecture3:340}
\BE
...
\begin{equation}\label{eqn:emtLecture3:360}
\begin{bmatrix}
A_r \\
A_\theta \\
A_\phi
...
%
\begin{equation}\label{eqn:emtLecture3:380}
\begin{bmatrix}
p_r \\
p_\theta \\
p_\phi
...
\begin{equation}\label{eqn:emtLecture3:420}
...
%
\begin{equation}\label{eqn:emtLecture3:440}
...
%
\begin{equation}\label{eqn:emtLecture3:260}
...
%
\begin{equation}\label{eqn:emtLecture3:460}
\BP = \frac{d\Bp}{dv}.
\end{equation}
%
...
%
\begin{equation}\label{eqn:emtLecture3:480}
\begin{aligned}
dV
...
Since
%
\begin{equation}\label{eqn:emtLecture3:500}
\spacegrad' \inv{R} = \frac{\rcap}{R^2},
\end{equation}
%
this can be written as
%
\begin{equation}\label{eqn:emtLecture3:520}
\begin{aligned}
V
&=
\inv{4 \pi \epsilon_0 }
...
%
\begin{equation}\label{eqn:emtLecture3:640}
...
\begin{equation}\label{eqn:emtLecture3:660}
\begin{aligned}
\spacegrad \cdot \BE &=
...
%
\begin{equation}\label{eqn:emtLecture3:720}
...
%
\begin{equation}\label{eqn:emtLecture3:740}
\begin{aligned}
\BD
&= \epsilon_0 \BE + \BP
