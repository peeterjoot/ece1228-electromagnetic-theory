...
%
\section{Lorentz-Lorenz Dispersion.}
%
...
%
\begin{equation}\label{eqn:emtLecture6:40}
\begin{aligned}
n &= \frac{c}{v}
...
We can also write
%
\begin{equation}\label{eqn:emtLecture6:60}
n(\omega) = n'(\omega) - j n''(\omega).
\end{equation}
%
If we are considering an electric dipole
%
\begin{equation}\label{eqn:emtLecture6:80}
\BP_i = Q_i \Bx_i.
\end{equation}
%
With
%
\begin{equation}\label{eqn:emtLecture6:100}
\BP = \epsilon_0 \chi_e \BE,
\end{equation}
%
and a time harmonic representation for the electric field
%
\begin{equation}\label{eqn:emtLecture6:120}
\BE = \BE_0 e^{j \omega t},
\end{equation}
%
the dipole moment is assumed to be
%
\begin{equation}\label{eqn:emtLecture6:140}
\begin{aligned}
...
This electron oscillator model is often called the Lorentz model.  It is not really a model for atoms as such, but the way that an atom responds to pertubation.  At the time when Lorentz formulated the model it was not known that the nuclei have massive mass as compared to the electrons.
The Lorentz assumption was that in the absence of applied electric fields the centroids of positive and negative charges coincide, but when a field is applied, the electrons will experience a Lorentz force and will be displaced from their equilibrium position.
...
%
or
\begin{equation}\label{eqn:emtLecture6:200}
...
so that
%
\begin{equation}\label{eqn:emtLecture6:240}
\frac{d^2 x}{dt^2} + \gamma \ddt{x} + \omega_0^2 x = \frac{Q E_0}{m} e^{j \omega t}.
\end{equation}
%
\section{Calculating the permittivity and susceptibility.}
%
With \( x = x_0 e^{j \omega t} \) we have
%
\begin{equation}\label{eqn:emtLecture6:260}
...
%
\begin{equation}\label{eqn:emtLecture6:300}
P(t) = N Q x,
\end{equation}
%
...
%
\begin{equation}\label{eqn:emtLecture6:440}
P(t)
...
%
\begin{equation}\label{eqn:emtLecture6:320}
\frac{P}{E}
...
%
%or
%\begin{equation}\label{eqn:emtLecture6:420}
%\epsilon_r
%= \frac{ \omega_0^2 -\omega^2 + j\gamma \omega + \omega_p^2}{\omega_0^2 -\omega^2 + j\gamma \omega }
%\end{equation}
%
It is simple to show that the real and imaginary split of \( \epsilon_r = \epsilon_r' -j \epsilon_r'' \) is given by
%
\begin{equation}\label{eqn:emtLecture6:460}
\epsilon_r' = \frac{\omega_p^2 \lr{ \omega_0^2 - \omega^2 } }{ (\omega_0^2 - \omega^2)^2 + (\omega \gamma)^2 } + 1,
\end{equation}
\begin{equation}\label{eqn:emtLecture6:480}
...
%
\begin{equation}\label{eqn:emtLecture6:500}
...
%
\begin{equation}\label{eqn:emtLecture6:540}
\begin{aligned}
...
%
\begin{equation}\label{eqn:emtLecture6:560}
