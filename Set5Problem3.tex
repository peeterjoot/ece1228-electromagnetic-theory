...
\begin{equation}\label{eqn:emtProblemSet5Problem3:80}
\BD(\Bx, t)
...
\begin{equation}\label{eqn:emtProblemSet5Problem3:100}
\begin{aligned}
\BD(\Bx, t)
...
\begin{equation}\label{eqn:emtProblemSet5Problem3:120}
\BD(\Bx, t)
=
\epsilon_0 \BE(\Bx, t)
+
...
\end{equation}
This shows that
\begin{equation}\label{eqn:emtProblemSet5Problem3:140}
\begin{aligned}
G(\tau)
&=
...
\begin{equation}\label{eqn:emtProblemSet5Problem3:160}
\epsilon(\omega) = \int \epsilon(t) e^{j \omega t} dt,
\end{equation}
or
\begin{equation}\label{eqn:emtProblemSet5Problem3:180}
\epsilon(-\omega) = \int \epsilon(t) e^{-j \omega t} dt.
\end{equation}
Assuming that \( \epsilon(t) \) is real, this is
\begin{equation}\label{eqn:emtProblemSet5Problem3:200}
\epsilon(-\omega) = \lr{ \int \epsilon(t) e^{j \omega t} dt }^\conj,
\end{equation}
or
\begin{equation}\label{eqn:emtProblemSet5Problem3:220}
...
\begin{equation}\label{eqn:emtProblemSet5Problem3:240}
\begin{aligned}
\epsilon(\omega)
&=
