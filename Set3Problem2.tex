...
%
\begin{equation}\label{eqn:emtProblemSet3Problem2:220}
\Br = z \Be_3.
\end{equation}
%
The charge point is
\begin{equation}\label{eqn:emtProblemSet3Problem2:240}
\Br' = R_l \lr{ \Be_1 \cos\theta' + \Be_2 \sin\theta' },
\end{equation}
%
and the element of the loop path is
\begin{equation}\label{eqn:emtProblemSet3Problem2:260}
d\Bl' = R_l d\theta' \lr{ \Be_2 \cos\theta' - \Be_1 \sin\theta'}.
\end{equation}
%
The difference vector from the charge position to the observation point is
%
\begin{equation}\label{eqn:emtProblemSet3Problem2:300}
\begin{aligned}
\BR
&= \Br - \Br'
\\ &=
...
with squared length
%
\begin{equation}\label{eqn:emtProblemSet3Problem2:320}
\BR^2
=
z^2 + R_l^2.
\end{equation}
...
%
\begin{equation}\label{eqn:emtProblemSet3Problem2:280}
\begin{aligned}
d\Bl' \cross \BR
&=
R_l d\theta'
...
%\begin{equation}\label{eqn:emtProblemSet3Problem2:201}
...
%
\begin{equation}\label{eqn:emtProblemSet3Problem2:380}
\BB
...
%
\begin{equation}\label{eqn:emtProblemSet3Problem2:420}
\BM
= \Be_3 I (2 \pi R_l),
\end{equation}
%
...
%
%\begin{equation}\label{eqn:emtProblemSet3Problem2:440}
...
%
\input{emtProblemSet3Appendix_pr2.tex}
}}
