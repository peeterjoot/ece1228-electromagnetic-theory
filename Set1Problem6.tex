...
%
\begin{equation}\label{eqn:emtProblemSet1Problem6:20}
...
%
\begin{equation}\label{eqn:emtProblemSet1Problem6:40}
...
\begin{equation}\label{eqn:emtProblemSet1Problem6:80}
\spacegrad \cross \BE = -j \omega \BB,
\end{equation}
\begin{equation}\label{eqn:emtProblemSet1Problem6:100}
\spacegrad \cross \BB = -j \omega \mu \epsilon \BE,
\end{equation}
\begin{equation}\label{eqn:emtProblemSet1Problem6:120}
\spacegrad \cdot \BE = 0,
\end{equation}
\begin{equation}\label{eqn:emtProblemSet1Problem6:140}
\spacegrad \cdot \BB = 0.
\end{equation}
\end{subequations}
%
...
%
\begin{equation}\label{eqn:emtProblemSet1Problem6:160}
\begin{aligned}
\BB
...
\begin{equation}\label{eqn:emtProblemSet1Problem6:180}
\begin{aligned}
\bcB &=
\Real \lr{\BB e^{j \omega t}}
\\ &=
-\frac{E_0}{\omega}
\lr{
\Be_1 \beta \sin\lr{ \frac{\pi}{a} x } + \Be_3 \frac{\pi}{a} \cos\lr{ \frac{\pi}{a} x }
...
%
or
%\begin{equation}\label{eqn:emtProblemSet1Problem6:200}
...
%
\begin{equation}\label{eqn:emtProblemSet1Problem6:220}
...
%
\begin{equation}\label{eqn:emtProblemSet1Problem6:300}
\begin{aligned}
...
%
or
\begin{equation}\label{eqn:emtProblemSet1Problem6:240}
\spacegrad^2 \BE
...
%
\begin{equation}\label{eqn:emtProblemSet1Problem6:260}
\spacegrad^2 \BE
=
...
%
%\begin{equation}\label{eqn:emtProblemSet1Problem6:280}
