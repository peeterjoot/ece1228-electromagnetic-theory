...
\begin{equation}\label{eqn:emtproblemSet8Problem3:20}
\begin{bmatrix}
E_{l,i}' \\
E_{r,i}'
\end{bmatrix}
...
\end{bmatrix}
\end{equation}
\begin{equation}\label{eqn:emtproblemSet8Problem3:40}
\BM =
g
\begin{bmatrix}
a & b \\
...
\end{bmatrix}
\end{equation}
\begin{equation}\label{eqn:emtproblemSet8Problem3:60}
g = \inv{1 - \rho_{i,j}^2},
\end{equation}
\end{subequations}
...
\begin{equation}\label{eqn:emtproblemSet8Problem3:80}
\beta_i = \frac{\omega}{c} n_i d_i \cos\theta_i
\end{equation}
\begin{equation}\label{eqn:emtproblemSet8Problem3:100}
...
where
\begin{equation}\label{eqn:emtproblemSet8Problem3:180}
...
%
\begin{equation}\label{eqn:emtproblemSet8Problem3:220}
...
%
This gives
\begin{equation}\label{eqn:emtproblemSet8Problem3:300}
\begin{aligned}
\begin{bmatrix}
A \\
B
...
\begin{equation}\label{eqn:emtproblemSet8Problem3:380}
...
%
so we also find
\begin{equation}\label{eqn:emtproblemSet8Problem3:460}
\tau_{12} \tau_{21} = 1 - \rho_{12}^2.
\end{equation}
%
Inserting this into \cref{eqn:emtproblemSet8Problem3:300}, we have
%
\begin{equation}\label{eqn:emtproblemSet8Problem3:480}
\begin{aligned}
\begin{bmatrix}
E'_{l,i} \\
E'_{r,i} \\
...
%
Since
\begin{equation}\label{eqn:emtproblemSet8Problem3:500}
\begin{aligned}
\begin{bmatrix}
E \\
F
...
%
so
\begin{equation}\label{eqn:emtproblemSet8Problem3:520}
\begin{aligned}
\begin{bmatrix}
E'_{l,i} \\
E'_{r,i} \\
...
%%%
%%%\begin{equation}\label{eqn:emtproblemSet8Problem3:580}
%%%\begin{aligned}
%%%\hat{a}
...
%%%and
%%%
%%%\begin{equation}\label{eqn:emtproblemSet8Problem3:600}
%%%\begin{aligned}
%%%\hat{b}
