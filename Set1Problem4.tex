...
%
\begin{equation}\label{eqn:emtProblemSet1Problem4:20}
\begin{aligned}
\BE(z)
...
%
\begin{equation}\label{eqn:emtProblemSet1Problem4:40}
\BE_1(z) = \frac{\sigma \sgn(z) \Be_3 }{2 \epsilon_0}.
\end{equation}
%
Subtracting the field for the disk of radius \( R \) above, we have
\begin{equation}\label{eqn:emtProblemSet1Problem4:60}
\begin{aligned}
\BE(z)
...
%
or
\begin{equation}\label{eqn:emtProblemSet1Problem4:80}
