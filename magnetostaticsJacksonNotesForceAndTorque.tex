...
\end{equation}
%
Ignoring that detail again, assuming the answer has something to do with the center of mass and parallel axis theorem, we can proceed with a constant approximation of the magnetic field
%
