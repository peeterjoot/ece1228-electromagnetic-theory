...
\begin{equation}\label{eqn:emtproblemSet8Problem2:100}
\begin{aligned}
\begin{bmatrix}
C \\
D
...
\begin{equation}\label{eqn:emtproblemSet8Problem2:120}
\begin{aligned}
r
&= r_{12} + D t_{21}
\\ &= r_{12} +
...
\begin{equation}\label{eqn:emtproblemSet8Problem2:140}
\begin{aligned}
t
&= C \frac{t_{23}}{\gamma}
\\ &=
...
\begin{equation}\label{eqn:emtproblemSet8Problem2:180}
T(\omega)
=
...
\begin{equation}\label{eqn:emtproblemSet8Problem2:220}
T(\omega)
=
...
%  That is
%
%%\begin{equation}\label{eqn:emtproblemSet8Problem2:240}
...
%
%\begin{equation}\label{eqn:emtproblemSet8Problem2:360}
%\theta_2 = \sin^{-1} \lr{ \frac{n_1}{n_2} \sin\theta_1 }.
%\end{equation}
%
\makeSubAnswer{}{emt:problemSet8:2b}
The index of refraction, in terms of \( \mu, \epsilon \) is
\begin{equation}\label{eqn:emtproblemSet8Problem2:260}
\begin{aligned}
n &= \frac{c}{v} \\ &= c \sqrt{ \mu \epsilon },
\end{aligned}
\end{equation}
so
\begin{equation}\label{eqn:emtproblemSet8Problem2:280}
\begin{aligned}
n_2
...
\begin{equation}\label{eqn:emtproblemSet8Problem2:380}
\begin{aligned}
k_{2z}
...
Let
\begin{equation}\label{eqn:emtproblemSet8Problem2:400}
\begin{aligned}
\alpha
&=
...
\begin{equation}\label{eqn:emtproblemSet8Problem2:300}
\begin{aligned}
T(\omega)
&=
...
\begin{equation}\label{eqn:emtproblemSet8Problem2:480}
\theta_2
...
\begin{equation}\label{eqn:emtproblemSet8Problem2:420}
\begin{aligned}
T(\omega)
&=
...
\begin{equation}\label{eqn:emtproblemSet8Problem2:440}
\begin{aligned}
\psi(2d, t)
