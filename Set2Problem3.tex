...
%
\begin{equation}\label{eqn:emtproblemSet2Problem3:20}
\spacegrad \psi =
\xcap_1 \PD{x}{\psi}
+\ycap_2 \PD{y}{\psi}
+\zcap \PD{z}{\psi},
...
%
\begin{equation}\label{eqn:emtproblemSet2Problem3:40}
\spacegrad \psi =
\rhocap \PD{\rho}{\psi}
...
\index{basis vectors}
\begin{equation}\label{eqn:emtProblemSet2Problem3:60}
\begin{aligned}
\begin{bmatrix}
...
\end{equation}
so
\begin{equation}\label{eqn:emtProblemSet2Problem3:120}
\begin{bmatrix}
\rhocap \cdot \spacegrad \psi \\
\phicap \cdot \spacegrad \psi \\
\zcap \cdot \spacegrad \psi \\
...
\end{equation}
or, in matrix form
\begin{equation}\label{eqn:emtProblemSet2Problem3:160}
\begin{bmatrix}
\PDi{x}{\psi} \\
\PDi{y}{\psi} \\
\PDi{z}{\psi}
...
\end{equation}
For example
\begin{equation}\label{eqn:emtProblemSet2Problem3:220}
\begin{aligned}
-\sin \phi \PD{x}{\phi}
...
\end{equation}
Similarly
\begin{equation}\label{eqn:emtProblemSet2Problem3:240}
\begin{aligned}
\cos \phi \PD{y}{\phi}
&= \frac{x^2}{\rho^3}
\\ &= \frac{\cos^2\phi}{\rho}.
...
\end{equation}
so
\begin{equation}\label{eqn:emtProblemSet2Problem3:280}
\begin{bmatrix}
\PDi{x}{\psi} \\
\PDi{y}{\psi} \\
\PDi{z}{\psi}
...
\begin{equation}\label{eqn:emtProblemSet2Problem3:320}
\begin{aligned}
\begin{bmatrix}
\rhocap \cdot \spacegrad \psi \\
\phicap \cdot \spacegrad \psi \\
...
\begin{equation}\label{eqn:emtProblemSet2Problem3:340}
\spacegrad \psi
=
...
\end{equation}
or
%\begin{equation}\label{eqn:emtProblemSet2Problem3:360}
