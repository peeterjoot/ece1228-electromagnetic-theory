...
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:20}
...
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:40}
...
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:60}
\spacegrad^2 \psi
=
...
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:80}
\begin{aligned}
0
...
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:100}
0 =
...
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:120}
\inv{P} P'' = -m^2,
\end{equation}
%
which has exponential (or trigonometric) solutions
%
%\begin{equation}\label{eqn:emtproblemSet7Problem2:440}
...
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:140}
0 =
...
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:160}
\frac{1}{ T S_\theta^2} \lr{ S_\theta T' }' - \frac{m^2}{S_\theta^2} = - n(n+1),
\end{equation}
%
or
\begin{equation}\label{eqn:emtproblemSet7Problem2:420}
...
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:180}
0 = \lr{ r^2 R' }' + \lr{ r^2 \beta^2 - n(n+1)} R,
\end{equation}
%
or
\begin{equation}\label{eqn:emtproblemSet7Problem2:200}
0 = r^2 R'' + 2 r R' + \lr{ r^2 \beta^2 - n(n+1) } R.
\end{equation}
%
After a variable substitution, \( z = r \beta \), this is
%
%\begin{equation}\label{eqn:emtproblemSet7Problem2:220}
...
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:240}
...
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:280}
\begin{aligned}
0
&=
...
%
We want
\begin{equation}\label{eqn:emtproblemSet7Problem2:300}
2 z \frac{q'}{q} + 2 = 1,
\end{equation}
%
which has solution
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:320}
q = z^{-1/2}.
\end{equation}
%
We also have
...
which gives
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:360}
0
= z^2 y'' + z y' + \lr{ z^2 - n(n+1) - \frac{1}{4} } y.
\end{equation}
%
Note that
\begin{equation}\label{eqn:emtproblemSet7Problem2:380}
\begin{aligned}
n(n+1) + \inv{4}
&=
...
%
%\begin{equation}\label{eqn:emtproblemSet7Problem2:400}
...
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:480}
\begin{aligned}
\frac{d}{d\theta}
&=
...
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:500}
\begin{aligned}
0
&=
...
Note that
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:520}
\begin{aligned}
...
so
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:540}
0
=
x (1-x^2) T''
+
...
%
\begin{equation}\label{eqn:emtproblemSet7Problem2:560}
\begin{aligned}
