...
% print out a message that only appears if redaction is active.
...
% completely omit content if redaction is active.
\newcommand{\skipIfRedacted}[1]{%
\ifthenelse{\boolean{redacted}}%
{\relax}%
{%
#1%
...
% ****************************************************************************************************
\newcommand{\myTitle}{Electromagnetic Theory\xspace}
\newcommand{\mySubtitle}{Notes and problems from UofT ECE1228H 2016\xspace}
\newcommand{\myDegree}{}
...
%----------------------
%\newcommand{\myVersion}{version v.4\xspace}
% To be posted to:
...
\hypersetup{%
    ...
    pdfsubject={Electromagnetic theory},%
    pdfkeywords={Electromagnetic theory} {ECE1228H} {University of Toronto},%
    pdfcreator={pdfLaTeX},%
...
% \shipoutAnswer required if this is used:
