...
\end{equation}
Moreover, the case of an \textit{active medium} (i.e. medium with gain) can be modelled by allowing \( \omega_{p,k} \)
...
\makeanswer{emt:problemSet5:2}{\withproblemsetsParagraph{
