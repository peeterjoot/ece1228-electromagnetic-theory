...
%
\begin{equation}\label{eqn:emtproblemSet6Problem1:20}
\PD{t}{\BJ_{\mathrm{sup}}} = \alpha \BE,
\end{equation}
%
and the second London equation
\begin{equation}\label{eqn:emtproblemSet6Problem1:40}
...
%
\begin{equation}\label{eqn:emtproblemSet6Problem1:80}
\begin{aligned}
...
%
or
\begin{equation}\label{eqn:emtproblemSet6Problem1:100}
\spacegrad \cross \dot{\BJ}_{\mathrm{sup}}
= -\alpha \dot{\BB},
\end{equation}
%
...
%
\begin{equation}\label{eqn:emtproblemSet6Problem1:120}
\begin{aligned}
0
&=
\PD{t}{} \lr{
...
%
or
\begin{equation}\label{eqn:emtproblemSet6Problem1:140}
...
\begin{equation}\label{eqn:emtproblemSet6Problem1:160}
\begin{aligned}
0
&=
...
%
\begin{equation}\label{eqn:emtproblemSet6Problem1:180}
...
\begin{equation}\label{eqn:emtproblemSet6Problem1:200}
\begin{aligned}
...
%
or
\begin{equation}\label{eqn:emtproblemSet6Problem1:220}
...
%
\begin{equation}\label{eqn:emtproblemSet6Problem1:300}
e^{-\sqrt{\alpha \mu_0} \delta}.
\end{equation}
%
The \( e^{-1} \) point is when
%
\begin{equation}\label{eqn:emtproblemSet6Problem1:320}
\sqrt{\alpha \mu_0} \delta = 1,
\end{equation}
%
or
\begin{equation}\label{eqn:emtproblemSet6Problem1:340}
\begin{aligned}
\delta
&= \inv{\sqrt{\alpha \mu_0} }
