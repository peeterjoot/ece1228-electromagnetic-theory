...
%
\begin{equation}\label{eqn:emtProblemSet1Problem3:20}
\begin{aligned}
\spacegrad \cross \BH
&=
...
%
\begin{equation}\label{eqn:emtProblemSet1Problem3:40}
\spacegrad \cross \BH
=
...
%
\begin{equation}\label{eqn:emtProblemSet1Problem3:60}
\begin{aligned}
\BH &=
\mu \begin{vmatrix}
\Be_1 & \Be_2 & \Be_3 \\
...
\begin{equation}\label{eqn:emtProblemSet1Problem3:100}
...
\begin{equation}\label{eqn:emtProblemSet1Problem3:140}
...
\begin{equation}\label{eqn:emtProblemSet1Problem3:180}
\BE = \inv{4\pi \epsilon} \iiint_V dV \frac{\rho}{\Abs{\Br}^2} +
